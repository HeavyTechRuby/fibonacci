...
Учатсники сообщества дополнили еще ряд спсобов.
...
Comparison:
       ...
       closed_form_expression:  5864374.8 i/s - 2.64x  slower
...
```
**Примечание:**
1) Результаты для `memoization` и `singleton` при размере 100_000 отсутствуют из-за переполнения стека.
2) Для замеров использовалась стандартная библиотека Ruby 'benchmark'.
